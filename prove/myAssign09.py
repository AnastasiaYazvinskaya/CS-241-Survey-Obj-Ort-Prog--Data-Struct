...
class Game(arcade.Window):
    ...
    def check_collisions(self):
        """
        Checking for collision between bullet and asteroid.
        They both will die if they are too close to each other.
        """
        for bullet in self.bullets:
            for asteroid in self.asteroids:
                if bullet.alive and asteroid.alive:
                    ...
                    # When hitting an asteroid, bullet and asteroid (on this step) die
    ...
    def cleanup_zombies(self):
        """ Deleting die objects (bullets and asteroids) """
        for bullet in self.bullets:
            if not bullet.alive:
