...
class LargeRock(Asteroid):
    ...
    def hit(self):
        ...
        asteroid = MediumRock()
        asteroid.velocity.dx = self.velocity.dx
        asteroid.velocity.dy = self.velocity.dy + math.sin(math.radians(270)
        new_asteroid.append(asteroid)
...
class Bullet(FlyingObjects):
    def __init__(self, ship_angle, ship_x, ship_y, ship_speed):
        super().__init__()
        ...
        self.speed = ship_speed + BULLET_SPEED
