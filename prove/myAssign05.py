...
class Point:
    """
    This class initialize the coordinates of the center of objects
    """
...
class Velocity:
    """
    This class initialize the random velocity for ball
    """
    def __init__(self):
...
class Ball:
    def __init__(self):
        """
        Initialize the starting point of the ball with the random y-coordinate
        """
        self.center = Point(BALL_RADIUS, random.uniform(BALL_RADIUS, SCREEN_HEIGHT-BALL_RADIUS))
    ...
    def advance(self):
        """
        Move the ball in x- and y-coordinates
        """
    ...
    def bounce_horizontal(self):
        """
        Change of direction of movement in x-coordinate
        """
        self.velocity.dx *= -1

    def bounce_vertical(self):
        """
        Change of direction of movement in y-coordinate
        """
        self.velocity.dy *= -1

    def restart(self):
        """
        Updating data to the original
        """
        self.center = Point(BALL_RADIUS, random.uniform(BALL_RADIUS, SCREEN_HEIGHT-BALL_RADIUS))
        self.velocity = Velocity()
...
class Paddle:
    def __init__(self):
        """
        Initialize the starting point of the paddle in the in the lower right corner
        """
        self.center = Point(SCREEN_WIDTH-PADDLE_WIDTH/2, PADDLE_HEIGHT/2)
    ...
    def move_up(self):
        """
        Move up until we reach the edge of the screen
        """
    ...
    def move_down(self):
        """
        Move down until we reach the edge of the screen
        """
